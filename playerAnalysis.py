...
def app():
    ...
    if Analyze:
        ...
        if len(selected_player_bat_df) != 0:
            ...
            fig.update_layout(
                title=f"{player.strip()}'s Batting Performance Against Other Teams",
                xaxis_title="Teams",
            ...
            fig.update_layout(
                title=f"{player.strip()}'s Batting Performance Against Different Bowlers [Top 15]",
                xaxis_title="Bowlers",
                yaxis_title="Total Runs Scored",
                plot_bgcolor='rgba(0,0,0,0)',
                paper_bgcolor='rgba(0,0,0,0)',
            ...
            fig.update_layout(
                title=f"{player.strip()}'s Batting Runs With Partner At non-striker [Top 15]",
                xaxis_title="Players",
                yaxis_title="Total Runs Scored",
                plot_bgcolor='rgba(0,0,0,0)',
                paper_bgcolor='rgba(0,0,0,0)',
            ...
            st.markdown(f"<h5 style='text-align: center; color: red;'> ⚠ Oops! Looks Like We Couldn't Find Any Batting Stats For {player} In IPL History ⚠</h5>", unsafe_allow_html=True)
        ...
        if len(selected_player_boll_df) != 0:
            ...
            fig.update_layout(
                title=f"Runs Scored By Different Players Against {player.strip()}'s (Top 15)",
                xaxis_title="Players",
                yaxis_title="Runs",
                plot_bgcolor='rgba(0,0,0,0)',
                paper_bgcolor='rgba(0,0,0,0)',
            ...
            fig.update_layout(
                title=f'Total Runs Given By {player.strip()} in Different Overs',
                xaxis_title="Overs",
            ...
            fig.update_layout(
                title=f'Runs Scored By Different Teams Against {player.strip()}',
                xaxis_title='Teams',
                yaxis_title='Runs',
                plot_bgcolor='rgba(0,0,0,0)',
                paper_bgcolor='rgba(0,0,0,0)',
            ...
            st.markdown(f"<h5 style='text-align: center; color: red;'> ⚠ Oops! Looks Like We Couldn't Find Any Bowling Stats For {player} In IPL History ⚠</h5>", unsafe_allow_html=True)
