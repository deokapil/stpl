    ...
    if t1 == t2:
        ...
        if Analyze:
            ...
            if total.empty:
                ...
                ###########################################################
                st.image("Images/divider.png")
                st. markdown(f"<h4 style='text-align: center; color: white;'> {t1} vs {t2} : Match Win Based On City  </h4>", unsafe_allow_html=True)
                ...
                plt.title(f'{t1} vs {t2} : Match Win Based On City',
                    fontsize=10
                )
                ...
                plt.title(f"Number of Sixes Hitted By Players of Team {t1} vs {t2} ")
                plt.ylabel('Players')
                ...
                plt.title(f"Number of fours Hitted By Players of Team {t1} vs {t2} ")
                plt.ylabel('Players')
                ...
                plt.title(f"Number of Sixes Hitted By Players of Team {t2} vs {t1} ")
                plt.ylabel('Players')
                plt.xlabel('Number of Sixes')
                ...
                plt.title(f"Number of fours Hitted By Players of Team {t2}  vs {t1} ")
                plt.ylabel('Players')
                plt.xlabel('Number of fours')
